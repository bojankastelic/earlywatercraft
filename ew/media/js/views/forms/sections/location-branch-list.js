    ...
    return BranchList.extend({
        initialize: function(options) {
            ...
            self.map.map.on('click', function(e) {
                self.map.map.forEachFeatureAtPixel(e.pixel, function (feature, layer) {
            ...
            this.baseLayers = self.map.baseLayers;
            ...
            self.$el.find(".geometry-btn").click(function (){ 
                ...
                if (draw) {
                    self.map.map.removeInteraction(draw);
                }
                ...
                self.map.map.addInteraction(draw);
            ...
            featureOverlay.setMap(self.map.map);
            ...
            self.map.map.addInteraction(modify);
        },
        ...
        zoomRegion: function(coordinates) {
