    ...
    function($, jqui, _, Backbone, bootstrap, arches, MapView, ol, ko, ResourceLayerModel, utils, resourceTypes) {
        ...
        return Backbone.View.extend({
            ...
            initialize: function(options) { 
                ...
                var styleFactory = function (color, zIndex, feature) {
                    var rgb = utils.hexToRgb(color);
                    // Dodatna logika za EW ikone
                    ewicon = feature.get('ewicon')
                    styleForIcon = ewicon.status + '.' + ewicon.color + '.' + ewicon.icon_type;
                ...
                var normalStyle = function (feature) {
                    return styleFactory(arches.resourceMarker.defaultColor, 1000000, feature);
                }
                var highlightStyle = function (feature) {
                    return styleFactory('#4CAE4C', 9999999, feature);
                }
